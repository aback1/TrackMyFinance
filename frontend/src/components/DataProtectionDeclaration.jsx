  ...
  return (
    <section className="data-protection-section">
      ...
      <div className="content-section">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">6. Hosting durch IONOS</h2>
        <p>
          Diese Website wird von der <strong>IONOS SE</strong> gehostet. Für die
          Nutzung der Hosting-Dienste gelten zusätzlich die
          Datenschutzbestimmungen von IONOS, die Sie unter folgendem Link
          einsehen können: {}
          <a
